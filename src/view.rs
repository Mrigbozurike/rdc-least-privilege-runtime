...
impl ViewMap {
    ...
    /// Image pixel → desktop point, clamped to the image bounds.
    pub fn to_desktop(self, px: f64, py: f64) -> (i32, i32) {
        let px = px.clamp(0.0, self.width as f64);
...
mod tests {
    ...
    fn scale_two_single_monitor() {
        ...
        assert_eq!(v.to_desktop(1568.0, 1045.0), (1440, 960));
